    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
          size="sm"
          className="h-10 gap-2 rounded-xl border border-border/60 bg-background px-2.5 text-muted-foreground shadow-sm hover:bg-muted/70 hover:text-foreground sm:px-3"
