...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed left-3 right-3 top-3 z-[100] flex w-auto flex-col gap-2 sm:left-auto sm:right-4 sm:top-4 sm:w-full sm:max-w-[360px]",
      className,
    )}
    {...props}
  />
...
const toastVariants = cva(
  [
    ...
    "rounded-xl border px-4 py-3.5 pr-9 shadow-lg shadow-black/8",
    "transition-all",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2.5 top-2.5 rounded-lg p-0.5 text-foreground/50 opacity-100 transition-opacity",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className={cn("text-xs leading-relaxed opacity-80 mt-0.5", className)} {...props} />
));
