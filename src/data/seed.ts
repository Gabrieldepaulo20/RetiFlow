...
export const emailSuggestions: EmailSuggestion[] = [
  {
    ...
    senderRisk: 'BAIXO',
    verificationSignals: ['Domínio do remetente confere', 'Fornecedor recorrente', 'CNPJ no boleto bate'],
    fraudSignals: [],
    createdAt: cd(14, 4),
  },
  {
  ...
  },
  {
    ...
    senderRisk: 'MEDIO',
    verificationSignals: ['Valor compatível com pedido anterior'],
    fraudSignals: ['Reply-To difere do domínio do remetente'],
    createdAt: cd(15, 4),
  },
  {
    id: 'esugg-4',
  ...
  {
    id: 'esugg-5',
    subject: 'URGENTE: Boleto em atraso — regularize hoje',
    senderName: 'Cobrança Premium',
    senderEmail: 'cobranca@premium-pagamentos-br.com',
    receivedAt: cd(16, 4),
    suggestedTitle: 'Boleto avulso — Cobrança Premium',
    suggestedAmount: 4990.00,
    suggestedDueDate: cd(17, 4),
    suggestedCategoryId: 'paycat-5',
    suggestedSupplierName: 'Cobrança Premium',
    suggestedPaymentMethod: 'PIX',
    confidence: 38,
    status: 'PENDING',
    suggestedStatus: 'INCERTO',
    emailSnippet: 'Identificamos pendência em seu nome. Pague via PIX para a chave abaixo e evite protesto.',
    senderRisk: 'ALTO',
    verificationSignals: [],
    fraudSignals: ['Domínio genérico recém-criado', 'PIX para pessoa física', 'Urgência/ameaça de protesto', 'Beneficiário não confere com fornecedor'],
    createdAt: cd(16, 4),
  },
  {
    id: 'esugg-6',
    subject: 'Possível cobrança — assinatura de software',
    senderName: 'SoftTools',
    senderEmail: 'billing@softtools.io',
    receivedAt: cd(13, 4),
    suggestedTitle: 'Assinatura SoftTools (a confirmar)',
    suggestedAmount: 149.90,
    suggestedDueDate: cd(20, 5),
    suggestedCategoryId: 'paycat-5',
    suggestedSupplierName: 'SoftTools',
    suggestedPaymentMethod: 'CARTAO_CREDITO',
    confidence: 48,
    status: 'PENDING',
    suggestedStatus: 'INCERTO',
    emailSnippet: 'Seu período de avaliação terminou. A cobrança pode ocorrer no próximo ciclo.',
    senderRisk: 'MEDIO',
    verificationSignals: ['Remetente já visto antes'],
    fraudSignals: ['Valor e vencimento não claros no corpo'],
    createdAt: cd(13, 4),
  },
];
