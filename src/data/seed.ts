...
/** Categorias padrão com timestamps — IDs estáveis definidos em domain/payables.ts */
export const payableCategories: PayableCategory[] = DEFAULT_PAYABLE_CATEGORIES.map(cat => ({
  ...cat,
  createdAt: cd(2, 1),
}));

export const payableSuppliers: PayableSupplier[] = [
  {
    id: 'psup-1',
    name: 'Distribuidora Santos Peças',
    tradeName: 'Santos Auto',
    docType: 'CNPJ',
    docNumber: '12.345.678/0001-90',
    phone: '(11) 3333-4444',
    email: 'contato@santosautopecas.com.br',
    isActive: true,
    createdAt: cd(2, 1),
  },
  {
    id: 'psup-2',
    name: 'Comercial Norte Motores',
    docType: 'CNPJ',
    docNumber: '98.765.432/0001-10',
    phone: '(11) 3456-5678',
    email: 'vendas@nortemotores.com.br',
    isActive: true,
    createdAt: cd(5, 1),
  },
  {
    id: 'psup-3',
    name: 'Ferramentas Precision Ltda',
    docType: 'CNPJ',
    docNumber: '55.666.777/0001-88',
    phone: '(11) 4567-8901',
    email: 'suporte@precisiontools.com.br',
    isActive: true,
    createdAt: cd(8, 1),
  },
];
 ...
 * Baseadas em "hoje = 13/04/2026" para que os status derivados (VENCIDO) façam sentido.
 */
export const payables: AccountPayable[] = [
  // ── Vencidas (status PENDENTE, dueDate < 13/04/2026) ─────────────────────
  {
    id: 'pay-1',
    title: 'Conta de Água — Março',
    supplierName: 'SABESP',
    categoryId: 'paycat-2',
    docNumber: '202600328815',
    issueDate: cd(1, 3),
    dueDate: cd(15, 3),
    originalAmount: 218.50,
    finalAmount: 218.50,
    status: 'PENDENTE',
    paymentMethod: 'BOLETO',
    entrySource: 'AUTO_SERIES',
    competencyDate: cd(1, 3),
    recurrence: 'MENSAL',
    isUrgent: true,
    createdAt: cd(1, 3),
    updatedAt: cd(1, 3),
  ...
  {
    id: 'pay-2',
    title: 'Peças — Distribuidora Santos',
    supplierId: 'psup-1',
    categoryId: 'paycat-1',
    docNumber: 'NF-00798',
    issueDate: cd(25, 3),
  ...
  {
    id: 'pay-3',
    title: 'Boleto — Distribuidora Santos',
    supplierId: 'psup-1',
    categoryId: 'paycat-1',
    docNumber: 'NF-00842',
    issueDate: cd(8, 4),
    dueDate: cd(14, 4),
    originalAmount: 1420.00,
    finalAmount: 1420.00,
    status: 'PENDENTE',
    paymentMethod: 'BOLETO',
    entrySource: 'IA_IMPORT',
    competencyDate: cd(1, 4),
    recurrence: 'NENHUMA',
    isUrgent: false,
    createdAt: cd(8, 4),
  ...
  {
    id: 'pay-4',
    title: 'Aluguel do Galpão — Abril',
    supplierName: 'Imobiliária Vieira',
    categoryId: 'paycat-3',
    dueDate: cd(20, 4),
  ...
  {
    id: 'pay-5',
    title: 'Mensalidade Contabilidade',
    supplierName: 'Escritório Fonseca',
    categoryId: 'paycat-7',
    dueDate: cd(28, 4),
  ...
  {
    id: 'pay-6',
    title: 'Energia Elétrica — Março',
    supplierName: 'Enel SP',
    categoryId: 'paycat-2',
    docNumber: '20260310045',
    issueDate: cd(2, 3),
    dueDate: cd(10, 3),
    originalAmount: 445.80,
    finalAmount: 445.80,
    paidAmount: 445.80,
    status: 'PAGO',
    paidWith: 'DEBITO_AUTOMATICO',
    paidAt: cd(10, 3),
    entrySource: 'AUTO_SERIES',
    competencyDate: cd(1, 3),
    recurrence: 'MENSAL',
  ...
  {
    id: 'pay-7',
    title: 'Peças — Comercial Norte Motores',
    supplierId: 'psup-2',
    categoryId: 'paycat-1',
    docNumber: 'NF-10234',
    issueDate: cd(28, 3),
    dueDate: cd(5, 4),
    originalAmount: 2180.00,
    discount: 100.00,
    finalAmount: 2080.00,
    paidAmount: 2080.00,
    status: 'PAGO',
  ...
  // ── IPTU em série (10 parcelas mensais) ───────────────────────────────────
  {
    id: 'pay-iptu-1',
    title: 'IPTU — Parcela 1/10',
    supplierName: 'Prefeitura Municipal',
    categoryId: 'paycat-4',
    docNumber: 'IPTU-2026-01',
    dueDate: cd(10, 1),
    originalAmount: 390.00,
    finalAmount: 390.00,
    paidAmount: 390.00,
    status: 'PAGO',
    paidWith: 'BOLETO',
  ...
  {
    id: 'pay-iptu-2',
    title: 'IPTU — Parcela 2/10',
    supplierName: 'Prefeitura Municipal',
    categoryId: 'paycat-4',
    docNumber: 'IPTU-2026-02',
    dueDate: cd(10, 2),
    originalAmount: 390.00,
    finalAmount: 390.00,
    paidAmount: 390.00,
    ...
    paidAt: cd(10, 2),
    entrySource: 'AUTO_SERIES',
    competencyDate: cd(1, 2),
    recurrence: 'MENSAL',
    recurrenceParentId: 'pay-iptu-1',
    recurrenceIndex: 2,
    totalInstallments: 10,
    isUrgent: false,
    createdAt: cd(2, 1),
  ...
  {
    id: 'pay-iptu-3',
    title: 'IPTU — Parcela 3/10',
    supplierName: 'Prefeitura Municipal',
    categoryId: 'paycat-4',
    docNumber: 'IPTU-2026-03',
    dueDate: cd(10, 3),
    originalAmount: 390.00,
    finalAmount: 390.00,
    paidAmount: 390.00,
  ...
  {
    id: 'pay-iptu-4',
    title: 'IPTU — Parcela 4/10',
    supplierName: 'Prefeitura Municipal',
    categoryId: 'paycat-4',
    docNumber: 'IPTU-2026-04',
    dueDate: cd(10, 4),
    originalAmount: 390.00,
    finalAmount: 390.00,
    status: 'PENDENTE',
  ...
  {
    id: 'pay-8',
    title: 'IPTU — Parcela 5/10',
    supplierName: 'Prefeitura Municipal',
    categoryId: 'paycat-4',
    docNumber: 'IPTU-2026-05',
    dueDate: cd(10, 5),
    originalAmount: 390.00,
    finalAmount: 390.00,
    status: 'AGENDADO',
    entrySource: 'AUTO_SERIES',
    competencyDate: cd(1, 5),
    paymentExecutionStatus: 'SCHEDULED',
    paymentProvider: 'Stark Bank (planejado)',
    recurrence: 'MENSAL',
    recurrenceParentId: 'pay-iptu-1',
    recurrenceIndex: 5,
    totalInstallments: 10,
  ...
  {
    id: 'pay-9',
    title: 'Assinatura Software Antigo',
...
export const payableAttachments: PayableAttachment[] = [];

export const payableHistory: PayableHistory[] = [];

export const emailSuggestions: EmailSuggestion[] = [
  {
    id: 'esugg-1',
    subject: 'Boleto Referente NF 00921 — Distribuidora Santos',
    senderName: 'Distribuidora Santos Peças',
    senderEmail: 'financeiro@santaspecas.com.br',
    receivedAt: cd(14, 4),
    suggestedTitle: 'Boleto — Distribuidora Santos NF-00921',
    suggestedAmount: 1850.00,
    suggestedDueDate: cd(28, 4),
    suggestedCategoryId: 'paycat-1',
    suggestedSupplierName: 'Distribuidora Santos Peças',
    suggestedPaymentMethod: 'BOLETO',
    confidence: 92,
    status: 'PENDING',
    emailSnippet: 'Prezado cliente, segue boleto referente à NF 00921 no valor de R$ 1.850,00 com vencimento em 28/04/2026.',
    createdAt: cd(14, 4),
  },
  {
    id: 'esugg-2',
    subject: 'Fatura de Energia Elétrica — Abril/2026',
    senderName: 'Enel SP',
    senderEmail: 'faturas@enelsp.com.br',
    receivedAt: cd(12, 4),
    suggestedTitle: 'Energia Elétrica — Abril',
    suggestedAmount: 512.40,
    suggestedDueDate: cd(10, 5),
    suggestedCategoryId: 'paycat-2',
    suggestedSupplierName: 'Enel SP',
    suggestedPaymentMethod: 'BOLETO',
    confidence: 97,
    status: 'PENDING',
    emailSnippet: 'Sua fatura de energia de Abril/2026 está disponível. Valor: R$ 512,40. Vencimento: 10/05/2026.',
    createdAt: cd(12, 4),
  },
  {
    id: 'esugg-3',
    ...
    receivedAt: cd(15, 4),
    suggestedTitle: 'Peças — Comercial Norte NF-10301',
    suggestedAmount: 3200.00,
    suggestedDueDate: cd(5, 5),
    suggestedCategoryId: 'paycat-1',
    suggestedSupplierName: 'Comercial Norte Motores',
    suggestedPaymentMethod: 'PIX',
    confidence: 85,
    status: 'PENDING',
    emailSnippet: 'Encaminhamos a NF-10301 referente ao pedido 4412. Total: R$ 3.200,00. Prazo: 20 dias.',
    createdAt: cd(15, 4),
  },
  {
    id: 'esugg-4',
    subject: 'Conta de Água — Março 2026 — SABESP',
    senderName: 'SABESP',
    senderEmail: 'noreply@sabesp.com.br',
    receivedAt: cd(2, 3),
    suggestedTitle: 'Conta de Água — Abril',
    suggestedAmount: 231.70,
    suggestedDueDate: cd(15, 5),
    suggestedCategoryId: 'paycat-2',
    suggestedSupplierName: 'SABESP',
    suggestedPaymentMethod: 'BOLETO',
    confidence: 95,
    status: 'DISMISSED',
    emailSnippet: 'Sua conta de água referência Abril/2026 está disponível. Valor total: R$ 231,70.',
    createdAt: cd(2, 3),
  },
];
