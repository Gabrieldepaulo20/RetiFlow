  ...
  try {
    ...
    try {
      ...
      const instructions = [
        ...
        '   - Se parecer uma conta já cadastrada (mesmo fornecedor, valor, vencimento ou documento repetido) mas não houver prova de parcela, use suggestedStatus: "INCERTO" e adicione warning com "possível conta repetida".',
